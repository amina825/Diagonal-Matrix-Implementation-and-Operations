...
namespace Diagonal
{
    public class Menu
    {
        ...
        private List<double> vec2 = new List<double>();
        ...
        private void AddMatrix()
        {
            ...
            List<double> secelements = new List<double>();
            ...
            for (int i = 0; i < n;i++)
            {
                ...
                try
                {
                    ...
                    if (elem == 0)
                    {
                        Console.WriteLine("non zero number is expected!");
                        ok = false;
                        break;
                    }
                    elements.Add(elem);
            ...
            if (ok)
            {
                for (int i = 0; i < n; i++)
                {
                    ...
                    try
                    {
                        double elemm = double.Parse(Console.ReadLine()!);
                        if (elemm == 0)
                        {
                            Console.WriteLine("non zero number is expected!");
                            ok = false;
